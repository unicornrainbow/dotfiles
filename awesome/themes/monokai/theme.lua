...
theme.bg_normal     = "#272821"
theme.bg_focus      = "#f1266f"
...
theme.taglist_bg_focus  = "#f1266f"
theme.tasklist_fg_focus = "#f8f8f2"
theme.tasklist_bg_focus = "#f1266f"
theme.titlebar_fg_focus = "#f8f8f2"
theme.titlebar_bg_focus = "#f1266f"
